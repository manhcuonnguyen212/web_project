...
import SafeQuillDeltaViewer from '../../components/SafeQuillDeltaViewer';
function PostDetail() {
        ...
        <article className="post-article">
          {postDetail?.thumbnail && (
            <div className="post-thumbnail">
              <img
                src={
                  postDetail.thumbnail.startsWith('http')
                    ? postDetail.thumbnail
                    : `${BASE_IMAGE_URL}${postDetail.thumbnail}`
                }
          ...
          <div className="post-content">
            {/* Rich Text: render Quill Delta bằng SafeQuillDeltaViewer, tuyệt đối XSS-safe, không HTML string, không react-quill */}
            {postDetail.contentDelta ? (
              <SafeQuillDeltaViewer delta={postDetail.contentDelta} />
              ...
              postDetail.content
                ...
                .map((block, index) => {
                  if (block.type === 'paragraph') {
                    return (
                      <SafeText key={index} className="content-paragraph" as="p">
                        {block.text}
                      </SafeText>
                    );
                        ...
                        <img
                          src={
                            block.url.startsWith('http')
                              ? block.url
                              : `${BASE_IMAGE_URL}${block.url}`
                          }
                          alt={block.alt || postDetail.title}
                        />
                        {block.caption && <figcaption><SafeText as="span">{block.caption}</SafeText></figcaption>}
                      </figure>
                    );
                  }
                  return null;
              ...
              <SafeText as="p">{postDetail.excerpt || 'Nội dung đang được cập nhật...'}</SafeText>
            )}
          </div>
              ...
              comments.map((c) => (
                ...
                >
                  ...
                  <div className="comment-body">
                    ...
                    <div className="comment-content"><SafeText as="span">{c.content}</SafeText></div>
                        ...
                        {c.replies.map((reply) => (
                          <div key={reply._id} className="comment-item reply-item">
                            ...
                            <div className="comment-body">
                              ...
                              <div className="comment-content"><SafeText as="span">{reply.content}</SafeText></div>
                              <div className="comment-actions">
                                <button
                                  className={`comment-action-btn ${
